...
After adjustment for seasonal Fourier terms and long-term trend, antecedent associations per $1\,\mathrm{SD}$ were heterogeneous (Table 15, Figure 7). These are predictive associations, not meteorological causal effects. Blocked validation provided mean full-model $\mathrm{PR\text{-}AUC}=0.779$ and Brier score 0.041; comparison with the seasonal-trend base model is in Table 16.
